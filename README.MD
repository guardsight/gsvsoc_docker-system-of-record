# Synopsis
This package has been created as a way to easily deploy a System-Of-Record. The logs will be kept on the parent system so they will be maintained and accessible ouside of the docker container.
